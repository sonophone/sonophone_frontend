...
export const APP_NAME = 'Sonophone'
export const APP_VERSION = '0.1.0'
export const DESCRIPTION = `${APP_NAME} decentralized music platform built with Lens Protocol 🌿`
export const DEFAULT_OG = 'https://assets.lenster.xyz/images/og/logo.jpeg'
export const RELAY_ON = false

// Post IDs
export const TRACK_ID = `${APP_NAME} Track`.toLowerCase()
export const PLAYLIST_ID = `${APP_NAME} Playlist`.toLowerCase()
export const PLAYLIST_ENTRY_ID = `${APP_NAME} Playlist Entry`.toLowerCase()
export const ALL_PUBLICATIONS = [TRACK_ID, PLAYLIST_ID, PLAYLIST_ENTRY_ID]

// URLs
export const PUBLIC_URL = 'https://sonophone.xyz'
